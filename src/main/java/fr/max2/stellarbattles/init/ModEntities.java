...
{
public static final DeferredRegister<EntityType<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.ENTITIES, StellarBattlesMod.MOD_ID);
	...
	{
		return REGISTRY.register(name, () -> tile.get().build(StellarBattlesMod.MOD_ID + ":" + name));
	}
