package fr.max2.stellarbattles.client.screen;
...
public class StarBeaconScreen extends ContainerScreen<StarBeaconContainer>
{
	...
	private static final ResourceLocation BEACON_GUI_TEXTURES = new ResourceLocation(StellarBattlesMod.MOD_ID, "textures/gui/container/star_beacon.png");
